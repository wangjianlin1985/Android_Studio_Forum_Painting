...
public class PaintListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(PaintListActivity.this, PaintQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(PaintListActivity.this, PaintAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new PaintSimpleAdapter(PaintListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(PaintListActivity.this, PaintDetailActivity.class);
	...
	private OnCreateContextMenuListener paintListItemListener = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			Declare declare = (Declare) PaintListActivity.this.getApplication();
			if(declare.getIdentify().equals("admin")) {
				menu.add(0, 0, 0, "编辑绘画信息"); 
				menu.add(0, 1, 0, "删除绘画信息");
			}
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑绘画信息
			...
			Intent intent = new Intent();
			intent.setClass(PaintListActivity.this, PaintEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("paintId", paintId);
			intent.putExtras(bundle);
			startActivityForResult(intent,ActivityUtils.EDIT_CODE);
		} else if (item.getItemId() == 1) {// 删除绘画信息
			ContextMenuInfo info = item.getMenuInfo();
			AdapterContextMenuInfo contextMenuInfo = (AdapterContextMenuInfo) info;
			// 获取选中行位置
			int position = contextMenuInfo.position;
	...
	protected void dialog() {
		Builder builder = new Builder(PaintListActivity.this);
